    ...
    <>
      <AtomCard className={classes.postCard}>
        <Box display="flex" paddingBottom="5px">
          ...
          <span className={classes.pr5}>({Math.round(author_reputation)})</span>
        ...
        >
          ...
          <Box display="flex" flexDirection="column">
            ...
            <hr style={{ width: "100%" }} />
            <Box display="flex">
              <Box className={classes.upArrowIcon} onClick={handleUpVote}>
                <ExpandLessRoundedIcon />
              </Box>
              <Box className={classes.downArrowIcon} onClick={handleDownVote}>
                  ...
                  >
                    <Box>
                      <ul className={classes.verticalMenuList}>
                        ...
                        {payoutAt && (
                          <li>Payout {moment(payoutAt).fromNow()}</li>
                        )}
                      </ul>
                    </Box>
                  </AtomCard>
